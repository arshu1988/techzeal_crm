...
INSERT INTO `groups` (`id`, `name`, `description`) VALUES
     (1,'admin_ahtsham','Administrator Ahtsham'),
	 (2,'admin_imran','Administrator Imran'),
     (3,'employee','Employee');
...
CREATE TABLE `users` (
  ...
  `active` int(2) unsigned DEFAULT NULL,
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `email`, `activation_code`, `forgotten_password_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES
     ('1','127.0.0.1','arshu1988','$2y$08$200Z6ZZbp3RAEXoaWcMA6uJOFicwNZaqk4oDhqTUiFXFe63MG.Daa','arshu1988@gmail.com','',NULL,'1268889823','1268889823','1', 'Ahtsham Uddin','Shaikh','','9893584813');
